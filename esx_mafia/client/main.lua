        ...
        if not DoesEntityExist(vehicle) then
          ...
          if Config.MaxInService == -1 then
            ...
            ESX.Game.SpawnVehicle(model, {
			  ...
			  SetVehicleNumberPlateText(vehicle," MAFIA  “ .. numberplate .. ”")
...
local blips = {
  ...
  -- {title="Mafia", colour=83, id=378, x = 71.16, y = -1861.01, z = 50.0},
...
AddEventHandler('esx_mafiajob:hasEnteredEntityZone', function(entity)
  ...
  if (PlayerData.job ~= nil and PlayerData.job.name == 'mafia') or (PlayerData.job2 ~= nil and PlayerData.job2.name == 'mafia') or (PlayerData.job3 ~= nil and PlayerData.job3.name == 'mafia') and not IsPedInAnyVehicle(playerPed, false) then
...
Citizen.CreateThread(function()
  ...
  while true do
    ...
    if (PlayerData.job ~= nil and PlayerData.job.name == 'mafia') or (PlayerData.job2 ~= nil and PlayerData.job2.name == 'mafia') or (PlayerData.job3 ~= nil and PlayerData.job3.name == 'mafia') then
      ...
      for k,v in pairs(Config.MafiaStations) do
		...
		if Config.EnablePlayerManagement and PlayerData.job2 ~= nil and PlayerData.job2.name == 'mafia' and PlayerData.job2.grade_name == 'boss' then
		...
		if Config.EnablePlayerManagement and PlayerData.job3 ~= nil and PlayerData.job3.name == 'mafia' and PlayerData.job3.grade_name == 'boss' then
...
Citizen.CreateThread(function()
  ...
  while true do
   ...
   if IsControlPressed(0,  Keys['F7']) and PlayerData.job ~= nil and PlayerData.job.name == 'mafia' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'mafia_actions') and (GetGameTimer() - GUI.Time) > 150 then
...
Citizen.CreateThread(function()
  ...
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'mafia' and (GetGameTimer() - GUI.Time) > 150 then
   ...
   if IsControlPressed(0,  Keys['F7']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'mafia' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'mafia_actions') and (GetGameTimer() - GUI.Time) > 150 then
...
Citizen.CreateThread(function()
  ...
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job3 ~= nil and PlayerData.job3.name == 'mafia' and (GetGameTimer() - GUI.Time) > 150 then
   ...
   if IsControlPressed(0,  Keys['F7']) and PlayerData.job3 ~= nil and PlayerData.job3.name == 'mafia' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'mafia_actions') and (GetGameTimer() - GUI.Time) > 150 then
